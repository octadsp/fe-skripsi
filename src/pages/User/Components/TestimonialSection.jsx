...
import Test from "../../../assets/star-solid.png"

function TestimonialSection() {
    return (
        // <section id="trademarksection" className="bg-navBg h-[500px] flex flex-col justify-center items-center">

        //     <h1 className="text-white/10 text-9xl translate-y-16">TESTIMONIAL</h1>

        //     <div className='carousel rounded-box w-[1200px]'>
        ...
        //     </div>
        // </section>
        <section class="bg-light-gray text-navBg">
            <div
            ...
            >
                <div class="max-w-7xl items-end justify-between sm:flex sm:pe-6 lg:pe-8">
                    <h2
                        class="max-w-xl text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl"
                    >
