            ...
            <div className="container w-1/2">
                <div className="flex justify-center text-center">
                    ...
                    <div>
                        ...
                        <p className="text-lg">At meter per second, we take pride in our values</p>
                ...
                <div className="container flex flex-col px-10 gap-5">
                    <Collapse title="Who We Are?" content="Established in 2012, with a vision of becoming a reliable workshop services company, providing fast, quality service and prioritizing customer satisfaction" />
                    <Collapse title="Who We Are?" content="Established in 2012, with a vision of becoming a reliable workshop services company, providing fast, quality service and prioritizing customer satisfaction" />
                    <Collapse title="Who We Are?" content="Established in 2012, with a vision of becoming a reliable workshop services company, providing fast, quality service and prioritizing customer satisfaction" />
                </div>
            </div>
