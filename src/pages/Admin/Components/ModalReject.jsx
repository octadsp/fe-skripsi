...
function ModalReject({ reservID }) {
  ...
  const handleSubmitReject = useMutation(async (e) => {
    try {
      e.preventDefault();
      ...
      document.getElementById("modalReject").close();
    } catch (error) {
  ...
  return (
    <dialog id="modalReject" className="modal">
      ...
      >
        <h3 className="font-bold text-lg">
          Why rejected {reserv?.kode_order} ?
        </h3>
